...
using Mtg.Database;
using Mtg.Web.Models.AuthModels;
...
namespace Mtg.Web.Controllers
{
    ...
    public class AuthController: Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            SignInStatus result = await SignInManager.PasswordSignInAsync(model.Username, model.Password, model.RememberMe, false);
            switch(result)
            {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if(ModelState.IsValid)
            {
                Player user = await UserManager.FindByNameAsync(model.Email);
